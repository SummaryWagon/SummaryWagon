...
from app.routers.image_resizing import upload_to_s3, download_from_s3
...
def word_preprocess(url : str):
    ...
    if response.status_code == 200:
        ...
        og_image_content_type = title_and_image[2]
        
        # Step 1-1: image S3에 저장하기
        original_image = upload_to_s3(og_title, og_image, og_image_content_type)
        resized_image = download_from_s3(original_image)
